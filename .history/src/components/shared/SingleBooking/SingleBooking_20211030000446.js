    ...
    return (
        <div className="flex mt-4">
            <div className="w-6/12 flex flex-col justify-center">
                ...
                <h3 className="text-xl text-left font-semibold text-gray-800 font-mono my-1">:<span>{userData.name}</span></h3>
                <h3 className="text-xl text-left font-semibold text-gray-800 font-mono my-1">:<span>{userData.email}</span> </h3>
                <h3 className="text-xl text-left font-semibold text-gray-800 font-mono my-1">:<span>{userData.phone}</span> </h3>
                <h3 className="text-xl text-left font-semibold text-gray-800 font-mono my-1">:<span>{userData.start_date}</span></h3>
