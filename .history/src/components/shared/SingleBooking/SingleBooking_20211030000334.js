    ...
    return (
        <div className="flex mt-4">
            <div className="w-6/12 flex flex-col justify-center">
                ...
                <h3 className="text-xl text-left font-semibold text-gray-800 font-mono my-1">{userData.name}</h3>
                <h3 className="text-xl text-left font-semibold text-gray-800 font-mono my-1">{userData.email}</h3>
                <h3 className="text-xl text-left font-semibold text-gray-800 font-mono my-1">{userData.phone}</h3>
                <h3 className="text-xl text-left font-semibold text-gray-800 font-mono my-1">{userData.start_date}</h3>
