    ...
    return (
        <div className="flex mt-4">
            ...
            <div className="w-6/12 border-l-4 border-gray-800 flex flex-col">
                ...
                <div className="flex">
                    <button className="px-4 py-1 bg-yellow-500 text-white font-semibold rounded-md">Cancel Booking</button>
                    <button
                        className="px-4 py-1 bg-yellow-500 text-white font-semibold rounded-md">
