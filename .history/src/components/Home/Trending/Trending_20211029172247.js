    ...
    return (
        <div>
            ...
            <div className="w-11/12 mx-auto grid grid-cols-4">
                <img className="transform hover:scale-125" src="https://images.unsplash.com/photo-1606199553171-aeb72afd49c1?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1031&q=80" />
