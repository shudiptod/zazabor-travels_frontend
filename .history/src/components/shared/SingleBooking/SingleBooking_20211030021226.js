        ...
        <div className="flex mt-4 ">
            ...
            <div className="w-6/12 border-l-4 border-gray-800 flex flex-col">
                ...
                <div className="flex w-8/12 mx-auto justify-around mt-3">
                    <button className="px-4 py-1 bg-yellow-600 text-white font-semibold rounded-md">{
                            ...
                            <>
                                {
                                    pending ? <button
                                        ...
                                        Approve Booking</button> : <button
                                            className="px-4 py-1 bg-white text-green-900 font-semibold rounded-md border-2 border-gray-900">
