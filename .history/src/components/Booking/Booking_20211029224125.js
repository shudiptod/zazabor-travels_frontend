    ...
    return (
        <div className="flex mt-4">
            <div className="w-6/12 border-r-4 border-gray-800 flex flex-col">
                ...
                <h2 className="text-center font-medium font-mono text-lg mt-2">Person: {singlePackage.people}</h2>
                <h2 className="text-center font-medium font-mono text-lg mt-2">Duration: {singlePackage.duration} Day(s)</h2>
                <h3 className="text-center font-medium font-mono text-xl mt-2">Price: {singlePackage.price} USD</h3>
                <p className="text-center font-medium font-mono text-md mt-2">{singlePackage.description}</p>
