    ...
    return (
        <div className="flex mt-4">
            <div className="w-6/12 flex flex-col justify-center">
                <h2 className="text-center font-semibold font-mono text-xl my-2">Customer Details</h2>
            ...
            <div className="w-6/12 border-l-4 border-gray-800 flex flex-col">
                <h2 className="text-left mx-auto font-semibold font-mono text-xl my-4 underline">Package Details</h2>
                <h2 className="text-left mx-auto font-semibold font-mono text-xl mt-2">{destination.name}</h2>
                <h2 className="text-left mx-auto font-semibold font-mono text-lg mt-2">Person: {destination.people}</h2>
                <h2 className="text-left mx-auto font-semibold font-mono text-lg mt-2">Duration: {destination.duration} Day(s)</h2>
                <h3 className="text-left mx-auto font-semibold font-mono text-xl mt-2">Price: {destination.price} USD</h3>
