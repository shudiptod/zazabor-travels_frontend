            ...
            <div className="w-6/12 flex justify-evenly">
                    ...
                    onClick={() => handleNavLink("/home")}>Home</button>
                {
                    user?.email ? <button className="font-semibold px-3 py-2 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-md"
                        onClick={() => handleNavLink("/myBookings")}>My Packages</button> : <></>
                }
                {
                    user?.email ? <button className="font-semibold px-3 py-2 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-md"
                        onClick={() => handleNavLink("/allBookings")}>All Packages</button> : <></>
                }
                {
                    user?.email ? <button className="font-semibold px-3 py-2 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-md"
                        onClick={() => handleNavLink("/add-package")}>Add Package</button> : <></>
                }
