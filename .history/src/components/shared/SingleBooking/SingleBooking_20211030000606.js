    ...
    return (
        <div className="flex mt-4">
            <div className="w-6/12 flex flex-col justify-center">
                ...
                <h3 className="text-xl text-left font-medium text-gray-800 font-mono my-1">Email: <span>{userData.email}</span> </h3>
                <h3 className="text-xl text-left font-medium text-gray-800 font-mono my-1">Phone: <span>{userData.phone}</span> </h3>
                <h3 className="text-xl text-left font-medium text-gray-800 font-mono my-1">Date: <span>{userData.start_date}</span></h3>
