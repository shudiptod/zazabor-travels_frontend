    ...
    return (
        <div className="flex mt-4">
            <div className="w-6/12 border-r-4 border-gray-800 flex flex-col">
                ...
                <h2 className="text-center font-medium font-mono text-md mt-2">Duration: {singlePackage.duration} Day(s)</h2>
                <p className="text-center font-medium font-mono text-md mt-2 px-10">{singlePackage.description}</p>
