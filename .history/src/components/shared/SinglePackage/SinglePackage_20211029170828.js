        ...
        <div className="container mx-auto lg:w-5/6 md:w-6/6 sm:w-5/6 h-full bg-gray-50 filter drop-shadow shadow-2xl border rounded-xl">
            ...
            <div className="container mx-auto w-5/6 px-1 py-2 flex flex-col">
                ...
                <div className="w-full flex items-center">
                    <h3 className="text-lg text-left text-gray-900 font-mono mb-5">{price} USD</h3>
                    <Link to={'/booking/' + key}>
                        <button className=" px-4 py-2 leading-normal text-md text-white font-semibold bg-blue-800  rounded-3xl
                border hover:border-indigo-800 hover:bg-gray-300 hover:text-gray-900 mt-7 mb-5">Book vacation</button>
                    </Link>
                </div>
