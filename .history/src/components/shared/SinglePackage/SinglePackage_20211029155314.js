...
const SinglePackage = (props) => {
    ...
    return (
        <div className="container mx-auto lg:w-5/6 md:w-6/6 sm:w-5/6 h-full bg-gray-900 filter drop-shadow shadow-2xl border rounded-xl text-white">
            ...
            <div className="container mx-auto w-full px-1 py-2 flex flex-col items-center">
                <h3 className="text-lg text-center text-white font-mono mb-5">{name}</h3>
                <p className="text-sm font-serif font-semibold text-white mb-2 w-10/12">{description.substring(0, 100) + '...'}</p>
                <Link to={'/booking/' + key}>
